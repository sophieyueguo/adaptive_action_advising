...
SCARED_TIME = 50     # Moves ghosts are scared
...
class PacmanRules:
    ...
    def consume( position, state, always_scared_mode=False):
        x,y = position
        # Eat food
...
class GhostRules:
    ...
    def collide( state, ghostState, agentIndex):
        ...
        if ghostState.scaredTimer > 0:
            # state.data.scoreChange += 1500 # ghost chaser
            # state.data.scoreChange -= 200 # ghost avoider
