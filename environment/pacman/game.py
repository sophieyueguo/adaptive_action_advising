...
class GameStateData:
    ...
    def __init__( self, prevState = None ):
        ...
        if prevState != None:
            ...
            self.num_capsule_eaten = prevState.num_capsule_eaten
            self.num_ghost_eaten = prevState.num_ghost_eaten
        else:
            self.num_capsule_eaten = 0
            self.num_ghost_eaten = 0
    ...
    def deepCopy( self ):
        ...
        state.num_capsule_eaten = self.num_capsule_eaten
        state.num_ghost_eaten = self.num_ghost_eaten
        return state
...
class Game:
    ...
    def init(self):
        ...
        for i in range(len(self.agents)):
            agent = self.agents[i]
        self.state.data.num_capsule_eaten = 0
        self.state.data.num_ghost_eaten = 0
